...
import augmented.security.asecuritysystem.firebase.User;

import static augmented.security.asecuritysystem.R.string.fail_regis;
import static augmented.security.asecuritysystem.R.string.usr_regis;
                        ...
                        if (task.isSuccessful()) {
                            ...
                            FirebaseDatabase.getInstance().getReference("Users")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(RegisterActivity.this, usr_regis, Toast.LENGTH_LONG).show();
                                        progressBar.setVisibility(View.GONE);
                                        startActivity(new Intent(RegisterActivity.this, LoginActivity.class));
                                    } else {
                                        Toast.makeText(RegisterActivity.this, fail_regis, Toast.LENGTH_LONG).show();
                                        progressBar.setVisibility(View.GONE);
                                    }
