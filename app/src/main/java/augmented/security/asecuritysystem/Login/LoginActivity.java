package augmented.security.asecuritysystem.Login;
...
import static augmented.security.asecuritysystem.R.string.Linkedgoogle;
import static augmented.security.asecuritysystem.R.string.UnsuccessGoogle;
import static augmented.security.asecuritysystem.R.string.pass_reset;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) { //handles the google sign in, and makes a google account
        try {
            ...
            Toast.makeText(LoginActivity.this, UnsuccessGoogle, Toast.LENGTH_LONG).show();
        ...
        FirebaseAuth.getInstance().sendPasswordResetEmail(email)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(LoginActivity.this, pass_reset, Toast.LENGTH_LONG).show();
                        }
                    }
                });
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(LoginActivity.this, Linkedgoogle, Toast.LENGTH_LONG).show();
