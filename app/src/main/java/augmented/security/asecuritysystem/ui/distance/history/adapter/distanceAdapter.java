...
public class distanceAdapter extends FirebaseRecyclerAdapter<distance, distanceAdapter.distanceViewholder> {

    public distanceAdapter(@NonNull FirebaseRecyclerOptions<distance> options) {
        super(options);
    }
